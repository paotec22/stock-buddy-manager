  ...
  return (
    <div className="rounded-xl border border-border/80 bg-card p-3 sm:p-4 shadow-xs space-y-3 print:p-0 print:border-none print:shadow-none print:rounded-none print:space-y-0 print:bg-transparent">
      ...
      <div className="print:hidden space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-3 bg-muted/30 p-2.5 sm:p-3 rounded-xl border border-border/50">
          {/* Invoice Number */}
          <div>
            <Label htmlFor="inv-no" className="text-xs sm:text-[11px] font-medium text-muted-foreground mb-1 flex items-center gap-1">
              <Hash className="h-3.5 w-3.5 sm:h-3 sm:w-3 text-primary" />
            ...
            <div className="flex items-center gap-1.5">
              <Input
                ...
                className="!min-h-0 h-10 sm:h-9 font-mono text-sm font-semibold bg-background"
              ...
              <Button
                ...
                variant="outline"
                size="icon"
                className="!min-h-0 h-10 w-10 sm:h-9 sm:w-9 shrink-0 bg-background active:scale-95 transition-transform"
          ...
          {/* Invoice Date */}
          <div>
            <Label className="text-xs sm:text-[11px] font-medium text-muted-foreground mb-1 flex items-center gap-1">
              <CalendarIcon className="h-3.5 w-3.5 sm:h-3 sm:w-3 text-primary" />
              Invoice Date
            </Label>
            <Popover>
              <PopoverTrigger asChild>
                <Button
                  variant="outline"
                  className="w-full !min-h-0 h-10 sm:h-9 justify-start text-left font-normal text-sm bg-background active:scale-[0.99] transition-transform"
                >
