...
export const InvoiceHeader = ({
  ...
  return (
    <div className="rounded-xl border border-border/80 bg-card p-3 sm:p-4 shadow-xs space-y-3 print:p-0 print:border-none print:shadow-none print:rounded-none print:space-y-1">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3 pb-2.5 border-b border-border/60">
        <div className="flex items-center gap-2.5">
          <Link to="/inventory" className="shrink-0 group">
            <div className="h-11 w-auto p-1 rounded-lg border border-border/60 bg-white dark:bg-slate-950 flex items-center justify-center transition-all group-hover:border-primary/50">
              <img 
              ...
              />
              <span className="font-bold text-primary text-sm tracking-tight px-1.5 hidden group-has-[:hidden]:inline">
                PUIDO SMART
              </span>
            </div>
          </Link>
        ...
        <div>
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button
                variant="outline"
                className="w-full !min-h-0 h-8 justify-start text-left font-normal text-xs sm:text-sm bg-background"
              >
