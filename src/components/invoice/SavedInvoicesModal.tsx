            ...
            <>
              ...
              <div className="block sm:hidden space-y-2.5">
                {filteredInvoices.map((inv) => {
                  ...
                  return (
                    <div key={inv.id} className="p-3.5 rounded-xl border border-border/80 bg-card space-y-2.5 shadow-2xs">
                      ...
                      <div className="flex items-center justify-end gap-1.5 pt-1">
                        {onLoadInvoice && (
                          <Button
                            ...
                            disabled={isLoading}
                            className="!min-h-0 h-9 px-3 text-xs text-primary font-medium hover:bg-primary/10 active:scale-95 transition-transform"
                          >
                            {isLoading ? (
                        ...
                        <Button
                          ...
                          className="!min-h-0 h-9 px-3 text-xs active:scale-95 transition-transform"
                        >
                        ...
                        {onDeleteInvoice && (
                          <Button
                            ...
                            className="!min-h-0 h-9 w-9 text-muted-foreground hover:text-destructive hover:bg-destructive/10 active:scale-95 transition-transform"
              ...
              <div className="hidden sm:block rounded-lg border border-border/80 overflow-hidden">
                <Table>
