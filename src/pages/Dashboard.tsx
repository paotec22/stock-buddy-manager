  ...
  return (
    <RoleProtectedRoute allowedRoles={['admin', 'uploader', 'inventory_manager', 'user']}>
      <div className="flex flex-col gap-4 sm:gap-6 animate-fade-in">
        <div className="relative overflow-hidden rounded-2xl border border-border/60 bg-card/60 backdrop-blur-sm p-4 sm:p-6 md:p-8 shadow-sm">
          <div className="absolute -right-24 -top-24 h-56 w-56 rounded-full bg-primary/10 blur-3xl pointer-events-none" />
          <div className="relative flex items-center gap-3">
            <span className="h-7 sm:h-8 w-1.5 rounded-full bg-primary" />
            <div>
              <h1 className="text-xl sm:text-3xl md:text-4xl font-bold tracking-tight text-foreground">Dashboard</h1>
              <p className="text-xs sm:text-sm text-muted-foreground mt-0.5 sm:mt-1">Welcome back. Here's what's happening with your store today.</p>
            </div>
          </div>
        </div>
