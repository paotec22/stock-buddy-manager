...
export const useInvoiceOperations = (
  ...
  const handlePrint = () => {
    ...
    printInvoiceDocument({
      ...
      customerPhone: typeof customerPhone === "string" && customerPhone.trim() ? customerPhone.trim() : undefined,
      customerAddress: typeof customerAddress === "string" && customerAddress.trim() ? customerAddress.trim() : undefined,
